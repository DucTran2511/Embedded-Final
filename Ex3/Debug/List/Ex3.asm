...
_0x0:
	...
	.DB  0x0,0x42,0x54,0x31,0x3A,0x20,0x47,0x49
	.DB  0x41,0x54,0x0,0x42,0x54,0x32,0x3A,0x20
	.DB  0x56,0x41,0x54,0x0,0x31,0x2E,0x20,0x47
	.DB  0x49,0x41,0x54,0x0,0x32,0x2E,0x20,0x56
	.DB  0x41,0x54,0x0,0x43,0x61,0x70,0x20,0x6E
	.DB  0x75,0x6F,0x63,0x0
_0x2020003:
	.DB  0x80,0xC0
_0x2120060:
	.DB  0x1
...
_glcd_list:
; .FSTART _glcd_list
; 0000 0020     glcd_outtextxy(10, 10, "MAY GIAT");
	LDI  R30,LOW(10)
	ST   -Y,R30
	ST   -Y,R30
	__POINTW2MN _0x3,0
	CALL _glcd_outtextxy
; 0000 0021     glcd_outtextxy(10, 20, "BT1: GIAT");
	LDI  R30,LOW(10)
	ST   -Y,R30
	LDI  R30,LOW(20)
	ST   -Y,R30
	__POINTW2MN _0x3,9
	CALL _glcd_outtextxy
; 0000 0022     glcd_outtextxy(10, 30, "BT2: VAT");
	LDI  R30,LOW(10)
	ST   -Y,R30
	LDI  R30,LOW(30)
	ST   -Y,R30
...
;
;void alcd_list(){
; 0000 0025 void alcd_list(){

	.CSEG
_alcd_list:
; .FSTART _alcd_list
; 0000 0026     char buffer_1[16];
; 0000 0027     char buffer_2[16];
...
;	buffer_2 -> Y+0
	...
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 0029     sprintf(buffer_1, "1. GIAT");
	MOVW R30,R28
	ADIW R30,16
	ST   -Y,R31
	ST   -Y,R30
...
; 0000 002B     lcd_gotoxy(0, 1);
	...
	LDI  R26,LOW(1)
	CALL SUBOPT_0x1
; 0000 002C     sprintf(buffer_2, "2. VAT");
	__POINTW1FN _0x0,36
	CALL SUBOPT_0x0
; 0000 002D     lcd_puts(buffer_2);
	MOVW R26,R28
	CALL _lcd_puts
; 0000 002E }
	ADIW R28,32
...
; 0000 0033     lcd_gotoxy(0, 0);
	...
	LDI  R26,LOW(0)
	CALL SUBOPT_0x1
; 0000 0034     sprintf(buffer, "Cap nuoc");
	__POINTW1FN _0x0,43
	CALL SUBOPT_0x0
; 0000 0035     lcd_puts(buffer);
	MOVW R26,R28
	CALL _lcd_puts
; 0000 0036     glcd_clear();
	CALL _glcd_clear
; 0000 0037     glcd_outtextxy(10, 10, "Cap nuoc");
	LDI  R30,LOW(10)
	ST   -Y,R30
	ST   -Y,R30
	__POINTW2MN _0x4,0
...
_main:
; .FSTART _main
; 0000 0040 bool state_1 = true;
; 0000 0041 bool state_2 = true;
; 0000 0042 init_glcd();
;	state_1 -> R17
;	state_2 -> R16
	LDI  R17,1
...
; 0000 004A         alcd_list();
	RCALL _alcd_list
; 0000 004B         if(PINB.2 == 0){
	SBIC 0x16,2
	RJMP _0x8
; 0000 004C             state_1 = !state_1;
	MOV  R30,R17
	CALL __LNEGB1
	MOV  R17,R30
; 0000 004D         }
; 0000 004E 
; 0000 004F         if(PINB.3 == 0){
_0x8:
	SBIC 0x16,3
	RJMP _0x9
; 0000 0050             state_2 = !state_2;
	MOV  R30,R16
	CALL __LNEGB1
	MOV  R16,R30
; 0000 0051         }
; 0000 0052 
; 0000 0053         if(state_1 == false){
_0x9:
	CPI  R17,0
	BRNE _0xA
; 0000 0054             giat();
	RCALL _giat
; 0000 0055             state_1 = !state_1;
	MOV  R30,R17
	CALL __LNEGB1
	MOV  R17,R30
; 0000 0056         }
; 0000 0057 
; 0000 0058         if(state_2 == false){
_0xA:
	CPI  R16,0
	BRNE _0xB
; 0000 0059             vat();
	RCALL _vat
; 0000 005A             state_2 = !state_2;
	MOV  R30,R16
	CALL __LNEGB1
	MOV  R16,R30
; 0000 005B         }
