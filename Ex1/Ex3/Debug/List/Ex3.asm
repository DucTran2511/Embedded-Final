...
_main:
; .FSTART _main
; 0000 003E bool state_1 = true;
; 0000 003F bool state_2 = true;
; 0000 0040 init_glcd();
;	state_1 -> R17
;	state_2 -> R16
	LDI  R17,1
...
; 0000 0048         alcd_list();
	RCALL _alcd_list
; 0000 0049         if(PINB.2 == 1){
	SBIS 0x16,2
	RJMP _0x7
; 0000 004A             state_1 = !state_1;
	MOV  R30,R17
	CALL __LNEGB1
	MOV  R17,R30
; 0000 004B         }
; 0000 004C 
; 0000 004D         if(PINB.3 == 1){
_0x7:
	SBIS 0x16,3
	RJMP _0x8
; 0000 004E             state_2 = !state_2;
	MOV  R30,R16
	CALL __LNEGB1
	MOV  R16,R30
; 0000 004F         }
; 0000 0050 
; 0000 0051         if(state_1 == false){
_0x8:
	CPI  R17,0
	BRNE _0x9
; 0000 0052             giat();
