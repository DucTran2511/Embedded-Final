...
_0x3:
	...
	.DB  0x8
_0x0:
	.DB  0x4D,0x61,0x74,0x20,0x6B,0x68,0x61,0x75
	.DB  0x20,0x64,0x75,0x6E,0x67,0x21,0x0,0x44
	.DB  0x6F,0x69,0x20,0x6D,0x61,0x74,0x20,0x6B
	.DB  0x68,0x61,0x75,0x3A,0x0,0x59,0x2F,0x4E
	.DB  0x0,0x4E,0x68,0x61,0x70,0x20,0x4D,0x4B
	.DB  0x20,0x6D,0x6F,0x69,0x3A,0x0,0x4D,0x61
	.DB  0x74,0x20,0x6B,0x68,0x61,0x75,0x20,0x64
	.DB  0x61,0x20,0x6C,0x75,0x75,0x21,0x0,0x53
	.DB  0x75,0x20,0x64,0x75,0x6E,0x67,0x20,0x4D
	.DB  0x4B,0x20,0x63,0x75,0x21,0x0,0x4E,0x68
	.DB  0x61,0x70,0x20,0x6D,0x61,0x74,0x20,0x6B
	.DB  0x68,0x61,0x75,0x3A,0x0,0x53,0x61,0x69
	.DB  0x21,0x20,0x43,0x6F,0x6E,0x20,0x25,0x64
	.DB  0x20,0x6C,0x61,0x6E,0x0,0x42,0x69,0x20
	.DB  0x6B,0x68,0x6F,0x61,0x21,0x0,0x31,0x30
	.DB  0x38,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0019     if (lock_triggered) {
	LDS  R30,_lock_triggered
	LDS  R31,_lock_triggered+1
	SBIW R30,0
	BREQ _0x4
; 0000 001A         dem += 1;
	LDS  R30,_dem_S0000000000
	LDS  R31,_dem_S0000000000+1
	ADIW R30,1
	STS  _dem_S0000000000,R30
	STS  _dem_S0000000000+1,R31
...
; 0000 0089         lock_triggered = 1; // Kich hoat che do khoa
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	STS  _lock_triggered,R30
	STS  _lock_triggered+1,R31
...
SUBOPT_0x0:
	LDS  R26,_dem_S0000000000
	LDS  R27,_dem_S0000000000+1
	LDI  R30,LOW(2000)
	LDI  R31,HIGH(2000)
	CALL __MODW21
	RET
...
SUBOPT_0x5:
	LDI  R30,LOW(_correct_password)
	LDI  R31,HIGH(_correct_password)
	ST   -Y,R31
	ST   -Y,R30
	RJMP SUBOPT_0x4
